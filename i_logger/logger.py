...
def log(log_content: str, log_type: Literal["critical", "command", "generic"] = "generic"):
    ...
    if log_type == "critical":
        ...
        file_header_message = "All CRITICAL errors, essentially any errors with the code!\n\n"
    elif log_type == "command":
        file_to_open = "command.log"
        file_header_message = "All COMMAND logs, any command use will be logged here!\n\n"
    ...
    with open("logs/" + file_to_open, "a") as file:
